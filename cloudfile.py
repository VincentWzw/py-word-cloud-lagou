...
wc= WordCloud(background_color="white",width=1000,height=860,font_path="C:\\Windows\\Fonts\\simkai.ttf")
#wc = WordCloud(background_color="white", max_words=2000,  mask = color_mask, max_font_size=40, random_state=42)
